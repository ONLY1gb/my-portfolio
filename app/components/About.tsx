            ...
            <div className="max-w-4xl mx-auto" ref={ref}>
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-lg text-gray-400 leading-relaxed">
                        ...
                        <motion.div variants={itemVariants}>
                            <p className="mb-6">
                                I love solving the "impossible" layout problems and optimizing animations until they run at a locked 60fps on a toaster.
                            </p>
                            <p>
                                Whether it's a complex dashboard or a whimsical portfolio, I treat every pixel as a promise of quality.
                            </p>
                        </motion.div>
                    </div>
                </motion.div>
